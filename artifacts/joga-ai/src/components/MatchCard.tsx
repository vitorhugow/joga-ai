...
import { FieldTypeBanner } from "@/components/FieldTypeBanner";
...
export function MatchCard({
  ...
  return (
    <Link href={href}>
      <div
        className="flex flex-col overflow-hidden rounded-2xl joga-tap"
        style={{
      ...
      >
        <FieldTypeBanner fieldType={resolvedFieldType} />
