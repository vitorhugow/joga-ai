      ...
      {hasCaixa ? (
        <>
          ...
          <p className="text-white/45 text-xs mt-1 leading-relaxed">
            Fica activa para todas as peladas com pagamento online. Os pagamentos só chegam à Caixa quando a pelada termina (concluída) — até lá ficam retidos na plataforma.
          </p>
          <JogaButton
            variant="ghost"
            size="sm"
