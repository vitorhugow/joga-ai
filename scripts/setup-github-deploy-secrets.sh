...
VITE_FIREBASE_VAPID_KEY="$(read_env VITE_FIREBASE_VAPID_KEY)"
VITE_RECAPTCHA_SITE_KEY="$(read_env VITE_RECAPTCHA_SITE_KEY)"

for key in VITE_FIREBASE_API_KEY VITE_FIREBASE_AUTH_DOMAIN VITE_FIREBASE_PROJECT_ID \
  VITE_FIREBASE_STORAGE_BUCKET VITE_FIREBASE_MESSAGING_SENDER_ID VITE_FIREBASE_APP_ID \
  VITE_FIREBASE_MEASUREMENT_ID VITE_FIREBASE_VAPID_KEY VITE_RECAPTCHA_SITE_KEY; do
